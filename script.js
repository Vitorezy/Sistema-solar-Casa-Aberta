...
function MudarPágina() {
  ...
  if (cont_pagina == 3) {
    ...
    conteudo_escrito.innerHTML =
      "<ol> <li>Diâmetro equatorial: 12.74 quilômetros.</li><li>Área da superfície: 510.100.000 km² </li><li>Massa: 5,972 × 10^24 kg.</li> </ol>";
    ...
    conteudo_escrito.innerHTML =
      "<ol> <li>Diâmetro equatorial: 139.8 quilômetros.</li><li>Área da superfície: 6,142 × 10^10 km²</li><li>Massa: 1,898 × 10^27 kg.</li> </ol>";
    curiosidade_pln.innerHTML =
    ...
    conteudo_escrito.innerHTML =
      "<ol> <li>Diâmetro equatorial: 116.4 quilômetros.</li><li>Área da superfície: 4,27 × 10^10 km²</li><li>Massa: 5,683 × 10^26 kg.</li> </ol>";
    curiosidade_pln.innerHTML =
    ...
    conteudo_escrito.innerHTML =
      "<ol> <li>Diâmetro equatorial: 50.72 quilômetros.</li><li>Área da superfície: 8,083 × 10^9 km²</li><li>Massa: 8,681 × 10^25 kg.</li> </ol>";
    curiosidade_pln.innerHTML =
    ...
    conteudo_escrito.innerHTML =
      "<ol> <li>Diâmetro equatorial: 6.779 quilômetros.</li><li>Área da superfície: 144.400.000 km²</li><li>Massa: 6,39 × 10^23 kg.</li> </ol>";
    curiosidade_pln.innerHTML =
    ...
    conteudo_escrito.innerHTML =
      "<ol> <li>Diâmetro equatorial: 49.24 quilômetros.</li><li>Área da superfície: 7,618 × 10^9 km²</li><li>Massa: 1,024 × 10^26 kg.</li> </ol>";
    curiosidade_pln.innerHTML =
    ...
    td_plnSat.innerHTML = "0";
    conteudo_escrito.innerHTML =
      "<ol> <li>Diâmetro equatorial: 12.10 quilômetros.</li><li>Área da superfície: 460.200.000 km²</li><li>Massa: 4,8685×1024 kg.</li> </ol>";
    curiosidade_pln.innerHTML =
